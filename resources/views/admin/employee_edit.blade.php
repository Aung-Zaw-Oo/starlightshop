            ...
            <div class="btn-group-wrapper">
                <div class="left-group">
                    ...
                    @elseif ($currentUserRole === 'Staff' && $isSelf)
                        ...
                        <button type="button" class="btn btn-danger" disabled title="You cannot delete yourself.">Delete</button>
                    @else
                        {{-- Staff editing others or any other case: no delete button --}}
                    @endif
                </div>
                <div class="right-group">
                    ...
                    @if ($currentUserRole === 'Staff' && !$isSelf)
                        ...
                        <button type="submit" class="btn btn-primary" disabled title="You cannot edit other users.">Save</button>
                    @else
