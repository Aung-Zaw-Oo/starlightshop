...
<div class="breadcrumb-bar">
    ...
    <div class="breadcrumb-right">
        <a href="{{ route('admin.product.create') }}" class="btn"><i class="fa-solid fa-plus"></i> Add</a>
    </div>
</div>
...
<!-- Mobile Cards -->
<div class="card-list mobile-only" id="product-card-list">
    @foreach ($products as $product)
        <div class="staff-card clickable-card" data-href="{{ route('admin.product.edit', $product->id) }}">
            <div class="card-header">
                <img class="avatar" src="{{ asset('storage/' . ($product->image ?? 'uploads/default-item.png')) }}" alt="Image">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    searchInput.addEventListener('keyup', () => {
        ...
        typingTimer = setTimeout(() => {
            ...
            fetch(`{{ route('admin.product.ajaxSearch') }}?query=${encodeURIComponent(query)}`, {
                headers: {
